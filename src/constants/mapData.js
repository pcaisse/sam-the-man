...
MapData.levels = [
	new Level([
		new Elevator({top: 350, left: 0, height: 50, width: 50, isMovingDown: false}),
		new Block({top: 200, left: 100, height: 50, width: 50}),
		new Block({top: 250, left: 150, height: 50, width: 100}),
		new Block({top: 250, left: 275, height: 50, width: 50}),
		new Block({top: 350, left: 450, height: 50, width: 50}),
		new Man({top: 0, left: 100, height: 50, width: 50, isFacingRight: true})
	])
];
